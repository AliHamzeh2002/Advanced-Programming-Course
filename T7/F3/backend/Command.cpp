...
Command::Command(string command_type, string command_name){
    type = command_type;
    name = command_name;
}

void Command::add_parameter(string param_name, string value){
    parameters.insert(make_pair(param_name, value));
}
